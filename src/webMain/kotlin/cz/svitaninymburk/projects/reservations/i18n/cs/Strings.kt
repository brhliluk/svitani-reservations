...
object CsStrings : AppStrings, ErrorStrings by CsErrorStrings {
    ...
    override val auditSubtitle = "Přihlášky, odhlášky, platby, odeslané e-maily a úpravy akce"
    ...
    override val auditResend = "Poslat e-mail znovu"
    override val auditResendConfirmTitle = "Poslat e-mail znovu?"
    override fun auditResendConfirmBody(recipient: String) = "E-mail se znovu odešle na $recipient."
    override val auditResendConfirmNote =
        "Obsah se sestaví z aktuálního stavu rezervace, takže QR kód nese dnešní nedoplatek."
    override val auditResendConfirm = "Poslat znovu"
    override fun auditResendSuccess(recipient: String) = "E-mail odeslán na $recipient."
    override fun auditEventLabel(type: AuditEventType): String = when (type) {
        ...
        AuditEventType.RESERVATION_CLAIMED -> "Přidání rezervace k účtu"
        AuditEventType.RESERVATION_LESSON_OPT_OUT -> "Omluvenka z lekce"
        AuditEventType.RESERVATION_LESSON_OPT_OUT_REVOKED -> "Omluvenka vzata zpět"
        ...
        AuditEventType.DEFINITION_CREATED -> "Šablona vytvořena"
        AuditEventType.DEFINITION_UPDATED -> "Šablona upravena"
        AuditEventType.DEFINITION_DELETED -> "Šablona smazána"
        AuditEventType.EVENT_CREATED -> "Akce vytvořena"
        AuditEventType.EVENT_UPDATED -> "Akce upravena"
        AuditEventType.EVENT_PUBLISHED -> "Akce zveřejněna"
        AuditEventType.EVENT_UNPUBLISHED -> "Akce skryta"
        AuditEventType.EVENT_DELETED -> "Akce smazána"
        AuditEventType.SERIES_CREATED -> "Kurz vytvořen"
        AuditEventType.SERIES_UPDATED -> "Kurz upraven"
        AuditEventType.SERIES_PUBLISHED -> "Kurz zveřejněn"
        AuditEventType.SERIES_UNPUBLISHED -> "Kurz skryt"
        AuditEventType.SERIES_DELETED -> "Kurz smazán"
        AuditEventType.LESSON_CREATED -> "Lekce přidána"
        AuditEventType.LESSON_UPDATED -> "Lekce upravena"
        AuditEventType.LESSON_PUBLISHED -> "Lekce zveřejněna"
        AuditEventType.LESSON_UNPUBLISHED -> "Lekce skryta"
        AuditEventType.LESSON_DELETED -> "Lekce smazána"
    ...
    override val allowMultipleSeats = "Umožnit rezervaci více míst"
    override val allowMultipleSeatsHint = "Pokud je vypnuto, rezervační formulář pole Počet míst skryje a rezervuje se vždy 1 místo."
    ...
    override val fieldTimeMultiplierToggle = "Použít jako cenový multiplikátor (cena × počet osob × hodiny)"
    override val fieldPriceModifierEnabled = "Upravuje cenu"
    override val fieldFlatFeeLabel = "Připočtená cena, pokud zaškrtnuto (Kč)"
    override val fieldFlatFeeFormula = "Vzorec: základní cena + příplatek (když zaškrtnuto)"
    ...
    override val fieldModifierNone = "Žádný"
    override val fieldModifierPerUnit = "Za jednotku"
    override val fieldModifierTiered = "Stupňovaná cena"
    override val fieldTieredAddTier = "+ Přidat stupeň"
    override val fieldTieredCountLabel = "Počet"
    override val fieldTieredPriceLabel = "Cena (Kč)"
    ...
    override val addLessonButton = "Přidat lekci"
    override val addLessonModalTitle = "Přidat lekci do kurzu"
    override val addLessonDateLabel = "Datum"
    ...
    override val paymentMethodWallet = "Kreditem"
    override val paymentMethodBankTransferAndWallet = "Převodem + kreditem"
    override val paymentMethodCashAndWallet = "Hotově + kreditem"
    ...
    override val cancellationEmailNotSent = "Rezervace je zrušená. Potvrzení e-mailem se nám teď nepodařilo odeslat, ale nic dalšího dělat nemusíte."
    ...
    override val settingsTitle = "Nastavení aplikace"
    override val settingsEmailCard = "E-mail"
    override val settingsPaymentCard = "Platby"
    override val settingsBankAccount = "Číslo bankovního účtu"
    override val settingsFioToken = "FIO API token"
    override val settingsSenderEmail = "Odesílací e-mailová adresa"
    override val settingsGmailPassword = "Heslo aplikace Gmail"
    override val settingsSenderDisplayName = "Zobrazované jméno odesílatele"
    override val settingsChangeButton = "Změnit"
    override val settingsTestEmailButton = "Odeslat testovací e-mail"
    override val settingsTestFioButton = "Otestovat FIO spojení"
    override val settingsSaveButton = "Uložit"
    override val settingsTestPassed = "Test proběhl úspěšně — lze uložit"
    ...
    override val optedOutSectionNote = "Nedrží místo a nejsou na prezenčce. Omluvenku za ně může vzít zpět jen admin."
    override val revokeOptOut = "Vrátit do lekce"
    override val tooltipRevokeOptOut = "Vzít omluvenku zpět"
    override val revokeOptOutConfirmTitle = "Vrátit do lekce?"
    override fun revokeOptOutConfirmText(name: String) = "$name se vrátí mezi účastníky téhle lekce."
