...
object EnStrings : AppStrings {
    ...
    override val fieldTimeMultiplierToggle = "Use as price multiplier (price × persons × hours)"
    override val fieldPriceModifierEnabled = "Modifies price"
    override val fieldFlatFeeLabel = "Added price when checked (CZK)"
    override val fieldFlatFeeFormula = "Formula: base price + flat fee (when checked)"
    ...
    override val fieldModifierNone = "None"
    override val fieldModifierPerUnit = "Per unit"
    override val fieldModifierTiered = "Tiered pricing"
    override val fieldTieredAddTier = "+ Add tier"
    override val fieldTieredCountLabel = "Count"
    override val fieldTieredPriceLabel = "Price (CZK)"
    ...
    override val addLessonButton = "Add lesson"
    override val addLessonModalTitle = "Add lesson to course"
    override val addLessonDateLabel = "Date"
    ...
    override val paymentMethodWallet = "Credit"
    override val paymentMethodBankTransferAndWallet = "Transfer + credit"
    override val paymentMethodCashAndWallet = "Cash + credit"
    ...
    override val settingsTitle = "Application Settings"
    override val settingsEmailCard = "Email"
    override val settingsPaymentCard = "Payments"
    override val settingsBankAccount = "Bank account number"
    override val settingsFioToken = "FIO API token"
    override val settingsSenderEmail = "Sender email address"
    override val settingsGmailPassword = "Gmail app password"
    override val settingsSenderDisplayName = "Sender display name"
    override val settingsChangeButton = "Change"
    override val settingsTestEmailButton = "Send test email"
    override val settingsTestFioButton = "Test FIO connection"
    override val settingsSaveButton = "Save"
    override val settingsTestPassed = "Test passed — you can now save"
