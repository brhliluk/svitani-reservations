...
object EnStrings : AppStrings {
    ...
    override val auditSubtitle = "Sign-ups, cancellations, payments, sent e-mails and changes to the event"
    ...
    override val auditResend = "Send e-mail again"
    override val auditResendConfirmTitle = "Send this e-mail again?"
    override fun auditResendConfirmBody(recipient: String) = "The e-mail will be sent again to $recipient."
    override val auditResendConfirmNote =
        "The content is rebuilt from the reservation as it stands now, so the QR code carries today's outstanding amount."
    override val auditResendConfirm = "Send again"
    override fun auditResendSuccess(recipient: String) = "E-mail sent to $recipient."
    override fun auditEventLabel(type: AuditEventType): String = when (type) {
        ...
        AuditEventType.RESERVATION_CLAIMED -> "Reservation linked to account"
        AuditEventType.RESERVATION_LESSON_OPT_OUT -> "Lesson opt-out"
        AuditEventType.RESERVATION_LESSON_OPT_OUT_REVOKED -> "Lesson opt-out revoked"
        ...
        AuditEventType.DEFINITION_CREATED -> "Template created"
        AuditEventType.DEFINITION_UPDATED -> "Template updated"
        AuditEventType.DEFINITION_DELETED -> "Template deleted"
        AuditEventType.EVENT_CREATED -> "Event created"
        AuditEventType.EVENT_UPDATED -> "Event updated"
        AuditEventType.EVENT_PUBLISHED -> "Event published"
        AuditEventType.EVENT_UNPUBLISHED -> "Event hidden"
        AuditEventType.EVENT_DELETED -> "Event deleted"
        AuditEventType.SERIES_CREATED -> "Course created"
        AuditEventType.SERIES_UPDATED -> "Course updated"
        AuditEventType.SERIES_PUBLISHED -> "Course published"
        AuditEventType.SERIES_UNPUBLISHED -> "Course hidden"
        AuditEventType.SERIES_DELETED -> "Course deleted"
        AuditEventType.LESSON_CREATED -> "Lesson added"
        AuditEventType.LESSON_UPDATED -> "Lesson updated"
        AuditEventType.LESSON_PUBLISHED -> "Lesson published"
        AuditEventType.LESSON_UNPUBLISHED -> "Lesson hidden"
        AuditEventType.LESSON_DELETED -> "Lesson deleted"
    ...
    override val cancellationEmailNotSent = "Your reservation is cancelled. We couldn't send the confirmation email right now, but there's nothing else you need to do."
    ...
    override val errorAdminRevokeOptOutNotFound = "The opt-out no longer exists."
    override val errorAdminRevokeOptOutLessonFull = "The lesson is full, someone else took the spot."
    override val errorAdminRevokeOptOutFailed = "The opt-out could not be revoked."
    override val errorAdminResendAuditEventNotFound = "That history entry no longer exists."
    override val errorAdminResendNotResendable = "This kind of e-mail cannot be sent again."
    override val errorAdminResendTargetNotFound = "The event this reservation belongs to no longer exists."
    override fun errorAdminResendSendFailed(cause: String) = "The e-mail could not be sent: $cause"
    ...
    override val optedOutSectionNote = "They hold no spot and are not on the attendance sheet. Only an admin can take the opt-out back."
    override val revokeOptOut = "Return to lesson"
    override val tooltipRevokeOptOut = "Revoke the opt-out"
    override val revokeOptOutConfirmTitle = "Return to the lesson?"
    override fun revokeOptOutConfirmText(name: String) = "$name will be listed among this lesson's participants again."
